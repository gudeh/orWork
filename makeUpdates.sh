...
designs=(
    "bp_single gf12"
    "ca53 gf12"
    "hercules_idecode rapidus2hp"
    "hercules_is_int rapidus2hp"
    "ibex gf12"
...
for entry in "${designs[@]}"; do
  ...
  #output=$(make PLATFORM_HOME=/platforms/ DESIGN_CONFIG="$config_path" update_ok 2>&1 || true)
  output=$(make PLATFORM_HOME=/home/aberndt/workspace/rapidus/current/rapidus/ DESIGN_CONFIG="$config_path" update_ok 2>&1 || true)
